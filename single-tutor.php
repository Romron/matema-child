...
<style>
    ...
    .popuptopphoto .photo, .popuptopphoto .tutor-photo, body .teacher-card .photo.tutor-place-photo {
    ...
    <div class="blue-sticky popdetails popteacher-card">
                ...
                <div class="sticky_body">
                    <h2 class="sticky-title"><?php switch (ICL_LANGUAGE_CODE) {
						...
						case 'pl':
							...
							break;
						case 'en':
							?>Sign up for a diagnostic lesson for 25 GBP<?php
							break;
						case 'ru':
							?>Запишись на урок-діагностику за ціною 150 грн.<?php
							break;
                    ...
                    <div class="sticky_desc_block">
                        ...
                        <div class="sticky_item">
                            ...
                            <h3 class="sticky_item_text"><?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>перший урок - тестування знань<?php
							break;
						case 'pl':
							?>Pierwsza lekcja - diagnoza wiedzy<?php
							break;
						case 'en':
							?>First lesson - knowledge diagnosis<?php
							break;
						case 'ru':
							?>первый урок - тестирование знаний<?php
							break;
						default:
							?>перший урок - тестування знань<?php
						} ?></h3>
                        ...
                        <div class="sticky_item">
                            ...
                            <h3 class="sticky_item_text"><?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>триває 45 хвилин<?php
							break;
						case 'pl':
							?>Trwa 45 minut<?php
							break;
						case 'en':
							?>It takes 45 minutes<?php
							break;
						case 'ru':
							?>Длится 45 минут<?php
							break;
                        ...
                        <div class="sticky_item">
                            ...
                            <h3 class="sticky_item_text"><?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>тест створений під ваші потреби<?php
							break;
						case 'pl':
							?>Praca diagnostyczna stworzona pod Twoje potrzeby<?php
							break;
						case 'en':
							?>Test tailored to your needs<?php
							break;
						case 'ru':
							?>Тест созданный под ваши потребности<?php
							break;
						default:
							?>тест створений під ваші потреби<?php
						} ?></h3>
                        ...
                        <div class="sticky_item">
                            ...
                            <h3 class="sticky_item_text"><?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>звіт від вчителя через 60 хвилин<?php
							break;
						case 'pl':
							?>Raport od nauczyciela po 60 minutach<?php
							break;
						case 'en':
							?>Teacher report after 60 minutes<?php
							break;
						case 'ru':
							?>Отчет от учителя через 60 минут<?php
							break;
						default:
							?>звіт від вчителя через 60 хвилин<?php
						} ?></h3>
                        ...
                        <div class="sticky_item">
                            ...
                            <h3 class="sticky_item_text"><?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>подальший план роботи<?php
							break;
						case 'pl':
							?>Dalszy plan pracy<?php
							break;
						case 'en':
							?>Further work plan<?php
							break;
						case 'ru':
							?>План дальнейшей работы<?php
							break;
						default:
							?>подальший план роботи<?php
						} ?></h3>
        ...
        <div class="buttons-wrap">
			<?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?><span class="button smaller tutpopup" onclick="PopupFunction(this);">Зареєструватись</span><?php
							break;
						case 'pl':
							?><span class="button smaller tutpopup" onclick="PopupFunction(this);">Zarezerwuj lekcję</span><?php
							break;
						case 'en':
							?><span class="button smaller tutpopup" onclick="PopupFunction(this);">Book a lesson</span><?php
							break;
						case 'ru':
							?><span class="button smaller tutpopup" onclick="PopupFunction(this);">Забронировать урок</span><?php
							break;
						default:
							?><span class="button smaller tutpopup" onclick="PopupFunction(this);">Зареєструватись</span><?php
						} ?>
    ...
    <div class="teacher-current">
        <div class="container popdetails popteacher-card">
            <div class="breadcrumbs-section">
				...
				<?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?><p><a href="/">Mathema.me</a><span class="separator"> &gt; </span><a href="/tutors/">Репетитори</a><span class="separator"> &gt; </span><span class="last"><?php the_title(); ?></span></p><?php
							break;
						case 'pl':
							?><p><a href="/">Mathema.me</a><span class="separator"> &gt; </span><a href="/pl/tutors/">Korepetytorzy</a><span class="separator"> &gt; </span><span class="last"><?php the_title(); ?></span></p><?php
							break;
						case 'en':
							?><p><a href="/">Mathema.me</a><span class="separator"> &gt; </span><a href="/en/tutors/">Tutors</a><span class="separator"> &gt; </span><span class="last"><?php the_title(); ?></span></p><?php
							break;
						case 'ru':
							?><p><a href="/">Mathema.me</a><span class="separator"> &gt; </span><a href="/ru/tutors/">Репетиторы</a><span class="separator"> &gt; </span><span class="last"><?php the_title(); ?></span></p><?php
							break;
						default:
							?><p><a href="/">Mathema.me</a><span class="separator"> &gt; </span><a href="/tutors/">Репетитори</a><span class="separator"> &gt; </span><span class="last"><?php the_title(); ?></span></p><?php
						} ?>
            ...
            <div class="row">
                <div class="teacher-head">
                    <div class="teacher-card teacher-currr">
                        <div class="photoblock">
                            ...
                            <div class="hide520">
								<?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							echo do_shortcode('[site_reviews_summary assigned_posts="post_id" text="на основі {num} відгуків" hide="if_empty,bars"]'); 
							break;
						case 'pl':
							echo do_shortcode('[site_reviews_summary assigned_posts="post_id" text="na podstawie {num} opinii" hide="if_empty,bars"]');
							break;
						case 'en':
							echo do_shortcode('[site_reviews_summary assigned_posts="post_id" text="based on {num} reviews" hide="if_empty,bars"]');
							break;
						case 'ru':
							echo do_shortcode('[site_reviews_summary assigned_posts="post_id" text="на основе {num} отзывов" hide="if_empty,bars"]');
							break;
						default:
							echo do_shortcode('[site_reviews_summary assigned_posts="post_id" text="на основі {num} відгуків" hide="if_empty,bars"]');
						} ?>	
							...
							?><div class="price"><?php $terms = get_the_terms($post->ID, 'tsina');
                                            ...
                                            <div class="button-price mobile">
                                                <div class="buttons-wrap">
                                                    <?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?><span class="button smaller tutpopup" onclick="PopupFunction(this);">Забронювати урок</span><?php
							break;
						case 'pl':
							?> <span class="button smaller tutpopup" onclick="PopupFunction(this);">Zarezerwuj lekcję</span><?php
							break;
						...
						case 'pl':
							...
							break;
						case 'en':
							?>Number of lessons conducted: <?php
							break;
						case 'ru':
						...
						case 'pl':
							?><div class="price"><?php $terms = get_the_terms($post->ID, 'tsina');
                                                                        echo join(', ', wp_list_pluck($terms, 'name')); ?> zl./god</div><?php
							break;
						case 'en':
							?><div class="price"><?php $terms = get_the_terms($post->ID, 'tsina');
                                                                        echo join(', ', wp_list_pluck($terms, 'name')); ?> GBP/hour</div><?php
							break;
						case 'ru':
							?><div class="price"><?php $terms = get_the_terms($post->ID, 'tsina');
                                                                        echo join(', ', wp_list_pluck($terms, 'name')); ?> грн./час
                                                    </div><?php
							break;
						default:
							?><div class="price"><?php $terms = get_the_terms($post->ID, 'tsina');
						...
						default:
							?>Кваліфікація<?php
                                    ...
                                    <?php if ((get_field('kilkist_uchniv') != "") || (get_field('zavantazhenist') != "") || (get_field('godini_roboti') != "")) { ?>
										...
										<?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>Доступність репетитора<?php
							break;
						case 'pl':
							?>Dostępność korepetytora<?php
							break;
						case 'en':
							?>Tutor availability<?php
							break;
						case 'ru':
							?>Доступность репетитора<?php
							break;
						default:
							?>Доступність репетитора<?php
						} ?>
                                    ...
                                    <?php if ((get_field('tehnichni_instrumenti') != "") || (get_field('opis_provedennya_urokiv') != "") || (get_field('veb-zastosunki') != "")) { ?>
										...
										<?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>Як проходить урок?<?php
							break;
						case 'pl':
							?>Jak przebiega lekcja?<?php
							break;
						case 'en':
							?>How does the lesson go?<?php
							break;
						case 'ru':
							?>Как проходит урок?<?php
							break;
						default:
							?>Як проходить урок?<?php
						} ?>
							...
							?>Відгуки<?php
                                ...
                                <div class="bio-section">
                                    <div class="teachers-bio greybotborder anch-bot-0">
                                            <h2><?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>Про репетитора<?php
							break;
						case 'pl':
						...
						default:
							?>Освіта<?php
                                                ...
                                                <div class="horizfl marg-left26">
                                                    ...
                                                    <span id="podtv" class="padleft5"><?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>Диплом підтверджено<?php
							break;
						case 'pl':
							?>Dyplom potwierdzony<?php
							break;
						case 'en':
							?>Diploma confirmed<?php
							break;
						case 'ru':
							?>Диплом подтверджен<?php
							break;
						default:
							?>Диплом підтверджено<?php
						} ?></span>
                                ...
                                ?>
                                    ...
                                    <div class="quali-section greybotborder anch-bot-0">
                                        <div class="teachers-quali ">
                                                <h2><?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>Кваліфікація репетитора<?php
							break;
						case 'pl':
							?>Kwalifikacja korepetytora<?php
							break;
						case 'en':
							?>Tutor qualification<?php
							break;
						case 'ru':
							?>Квалификация репетитора<?php
							break;
						default:
							?>Кваліфікація репетитора<?php
						} ?></h2>
                                                ...
                                                ?>
                                                    <div class="marg-left26 topgreyborder">
                                                        <h4><?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>Навчальні програми<?php
							break;
						case 'pl':
							?>Programy nauczania<?php
							break;
						case 'en':
							?>Curricula<?php
							break;
						case 'ru':
							?>Учебные программы<?php
							break;
						default:
							?>Навчальні програми<?php
						} ?></h4>
                                                ...
                                                ?>
                                                    <div class="marg-left26 topgreyborder">
                                                        <h4><?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>Рівні навчальних програм<?php
							break;
						case 'pl':
							?>Poziomy programów nauczania<?php
							break;
						case 'en':
							?>Curriculum Levels<?php
							break;
						case 'ru':
							?>Уровни учебных программ<?php
							break;
						default:
							?>Рівні навчальних програм<?php
						} ?></h4>
                                                ...
                                                ?>
                                                    <div class="marg-left26 topgreyborder">
                                                        <h4><?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>Підготовка до іспитів/олімпіад з математики<?php
							break;
						case 'pl':
							?>Przygotowanie do egzaminów/olimpiad z matematyki<?php
							break;
						case 'en':
							?>Preparation for mathematics exams/olympiads<?php
							break;
						case 'ru':
							?>Подготовка к экзаменам/олимпиадам по математике<?php
							break;
						default:
							?>Підготовка до іспитів/олімпіад з математики<?php
						} ?></h4>
                                                ...
                                                ?>
                                                    <div class="marg-left26 topgreyborder bottom_tutor_info">
                                                        <strong><?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>Додаткові предмети, що викладає репетитор:<?php
							break;
						case 'pl':
							?>Przedmioty dodatkowe prowadzone przez korepetytora:<?php
							break;
						case 'en':
							?>Additional subjects taught by the tutor:<?php
							break;
						case 'ru':
							?>Дополнительные предметы, которые преподает репетитор:<?php
							break;
						default:
							?>Додаткові предмети, що викладає репетитор:<?php
                                                ...
                                                <?php if (get_field('robota_z_osoblivimi_ditmi') && (get_field('robota_z_osoblivimi_ditmi') != "") && (get_field('robota_z_osoblivimi_ditmi') != "ні")) { ?>
                                                    <div class="marg-left26 topgreyborder bottom_tutor_info">
                                                        <strong><?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>Робота з дітьми з додатковими освітніми потребами<?php
							break;
						case 'pl':
							?>Praca z dziećmi z dodatkowymi potrzebami edukacyjnymi<?php
							break;
						case 'en':
							?>Working with children with additional educational needs<?php
							break;
						case 'ru':
							?>Работа с детьми с дополнительными образовательными потребностями<?php
							break;
						default:
							?>Робота з дітьми з додатковими освітніми потребами<?php
						} ?>: </strong><?php the_field('robota_z_osoblivimi_ditmi'); ?>
                                                    </div><?php } ?>
                                        </div>
                                    </div>
                                <?php } ?>
                                    ...
                                    <div class="nmt-section">
                                        <div class="teachers-nmt">
                                                <?php if (get_field('pidgotovka_do_nmt') || (get_field('najkrashhij') != "") || (get_field('serednij_rezultat_nmt') != "")) { ?>
                                                    <h2><?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>Підготовка до НМТ<?php
							break;
						case 'pl':
							?>Przygotowanie do Matury<?php
							break;
						case 'en':
							?>Preparation for GCSE<?php
							break;
						case 'ru':
							?>Подготовка к НМТ<?php
							break;
						default:
							?>Підготовка до НМТ<?php
						} ?></h2>
                                                    ...
                                                    <?php if (get_field('najkrashhij') && (get_field('najkrashhij') != "")) { ?>
                                                        <div class="horizfl marg-left26 marbot10 nmt-padding-none">
                                                            ...
                                                            <span class="padleft5"><?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>Найкращий учнівський результат - <?php the_field('najkrashhij'); ?> балів<?php
							break;
						case 'pl':
							?>Najlepszy wynik ucznia - <?php the_field('najkrashhij'); ?> punktów<?php
							break;
						case 'en':
							?>The best student result - <?php the_field('najkrashhij'); ?> points<?php
							break;
						case 'ru':
							?>Лучший результат ученика - <?php the_field('najkrashhij'); ?> баллов<?php
							break;
						default:
							?>Найкращий учнівський результат - <?php the_field('najkrashhij'); ?> балів<?php
						} ?></span>
                                                    ...
                                                    <?php if (get_field('serednij_rezultat_nmt') && (get_field('serednij_rezultat_nmt') != "")) { ?>
                                                        <div class="horizfl marg-left26 marbot5 nmt_padding_bottom">
                                                            ...
                                                            <span class="padleft5"><?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>Середній учнівський результат - <?php the_field('serednij_rezultat_nmt'); ?> балів<?php
							break;
						case 'pl':
							?>Średni wynik ucznia - <?php the_field('serednij_rezultat_nmt'); ?> punktów<?php
							break;
						case 'en':
							?>Average student result - <?php the_field('serednij_rezultat_nmt'); ?> points<?php
							break;
						case 'ru':
							?>Средний результат учеников - <?php the_field('serednij_rezultat_nmt'); ?> баллов<?php
							break;
						default:
							?>Середній учнівський результат - <?php the_field('serednij_rezultat_nmt'); ?> балів<?php
						} ?></span>
							...
							?>Доступність репетитора<?php
                                                ...
                                                <?php if (get_field('kilkist_uchniv') && (get_field('kilkist_uchniv') != "")) { ?>
                                                    <div class="marg-left26 marbot10 nmt-padding-none">
                                                        <strong><?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>Кількість активних учнів: </strong><?php the_field('kilkist_uchniv'); ?> учнів<?php
							break;
						case 'pl':
							?>Liczba aktywnych uczniów: </strong><?php the_field('kilkist_uchniv'); ?> uczniów<?php
							break;
						case 'en':
							?>Number of active students: </strong><?php the_field('kilkist_uchniv'); ?> students<?php
							break;
						case 'ru':
							?>Количество активных учеников: </strong><?php the_field('kilkist_uchniv'); ?> учеников<?php
							break;
						default:
							?>Кількість активних учнів: </strong><?php the_field('kilkist_uchniv'); ?> учнів<?php
						} ?>
							...
							?>Завантаженість<?php
                                                ...
                                                <?php if (get_field('godini_roboti') && (get_field('godini_roboti') != "")) { ?>
                                                    <div class="horizfl marg-left26 marbot10 flex-sta">
                                                        ...
                                                        <div class="padleft5"><strong><?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>Години роботи репетитора<?php
							break;
						case 'pl':
							?>Godziny pracy korepetytora<?php
							break;
						case 'en':
							?>Tutor work hours<?php
							break;
						case 'ru':
							?>Часы работы репетитора<?php
							break;
						default:
							?>Години роботи репетитора<?php
						} ?>: </strong><br><?php the_field('godini_roboti'); ?></div>
                                                    </div><?php } ?>
                                        </div>
                                    </div>
                                                ...
                                                <?php if (get_field('opis_provedennya_urokiv') && (get_field('opis_provedennya_urokiv') != "")) { ?>
                                                    ...
                                                    <?php if (get_field('tehnichni_instrumenti') && (get_field('tehnichni_instrumenti') != "")) { ?>
                                                        <div class="marg-left26 marbot10 nmt-padding-none yak-pm">
                                                            <strong><?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>Технічні інструменти вчителя<?php
							break;
						case 'pl':
							?>Techniczne narzędzia nauczyciela<?php
							break;
						case 'en':
							?>Teacher's technical tools<?php
							break;
						case 'ru':
							?>Технические инструменты учителя<?php
							break;
						default:
							?>Технічні інструменти вчителя<?php
						} ?>: </strong><?php the_field('tehnichni_instrumenti'); ?>
                                                        </div><?php } ?>
                                                    <?php if (get_field('veb-zastosunki') && (get_field('veb-zastosunki') != "")) { ?>
                                                        <div class="marg-left26 marbot10 nmt-padding-none" style="color:#000">
                                                            <strong><?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>Веб-застосунки, що використовуються<?php
							break;
						case 'pl':
							?>Wykorzystywane aplikacje webowe<?php
							break;
						case 'en':
							?>Web applications used<?php
							break;
						case 'ru':
							?>Веб-приложения, которые используются<?php
							break;
						default:
							?>Веб-застосунки, що використовуються<?php
						} ?>:</strong> <?php the_field('veb-zastosunki'); ?>
                                                        </div><?php } ?>
                                            <?php } ?>
                                        </div>
                                    </div>
						...
						default:
							?>Тарифи<?php
                                    ...
                                    <div class="slider_box_pricing">
                                        <button id="prevBtn" style="background: none;border: none;cursor: pointer;image-rendering: inherit;" onclick="prevSlide()"><img src="https://mathema.me/wp-content/uploads/2024/02/button-prev.png" style="image-rendering: inherit;" alt="попередні"></button>
                                        <div class="row">

                                            <div class="col">
                                                <div class="plan">
                                                    <h3><?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>10 уроків<?php
							break;
						case 'pl':
						...
						default:
							?>10 уроків<?php
                                                    ...
                                                    <div class="plan-description">
                                                        <p><?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>Підготуєтеся до контрольної або самостійної роботи<?php
							break;
						case 'pl':
							?>Przygotuj się do kontroli lub samodzielnej pracy<?php
							break;
						case 'en':
							?>Prepare for a test or homework<?php
							break;
						case 'ru':
							?>Подготовитесь к контрольной или самостоятельной работе<?php
							break;
						default:
							?>Підготуєтеся до контрольної або самостійної роботи<?php
						} ?></p>
                                                    ...
                                                    <div class="price">
                                                        <?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?><h2>390<span><b>грн./55 хв.</b></span></h2><?php
							break;
						case 'pl':
							?><h2>114<span><b>zl./god</b></span></h2><?php
							break;
						case 'en':
							?><h2>39<span><b>GPB/hour</b></span></h2><?php
							break;
						case 'gb':
							?><h2>39<span><b>GPB/hour</b></span></h2><?php
							break;	
						case 'ru':
							?><h2>390<span><b>грн./55 мин.</b></span></h2><?php
							break;
						default:
							?><h2>390<span><b>грн./55 хв.</b></span></h2><?php
						} ?>
                                                    ...
                                                    <?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?><span class="button button-plan-selection button-package tutpopup" onclick="PopupFunction(this)">Обрати<?php
							break;
						case 'pl':
							?><span class="button button-plan-selection button-package tutpopup" onclick="PopupFunction(this)">Wybierz<?php
							break;
						case 'en':
							?><span class="button button-plan-selection button-package tutpopup" onclick="PopupFunction(this)">Choose<?php
							break;
						case 'gb':
							?><a href="<?php echo get_page_link('11079'); ?>" class="button button-plan-selection button-package">Choose<?php
							break;
						case 'ru':
							?><span class="button button-plan-selection button-package tutpopup" onclick="PopupFunction(this)">Выбрать<?php
							break;
						default:
							?><span class="button button-plan-selection button-package tutpopup" onclick="PopupFunction(this)">Обрати<?php
						} ?>
						...
						default:
							?>20 уроків<?php
                                                    ...
                                                    <div class="plan-description">
                                                        <p><?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>Глибоко опрацюєте теми шкільної програми і теми, які даються вам складно<?php
							break;
						case 'pl':
							?>Dokładnie przestudiujesz tematy programu szkolnego oraz tematy, które są dla Ciebie trudne<?php
							break;
						case 'en':
							?>You will deeply study the topics of the school program and topics that are difficult for you<?php
							break;
						case 'gb':
							?>You will deeply study the topics of the school program and topics that are difficult for you<?php
							break;
						case 'ru':
							?>Глубоко проработаете темы школьной программы и темы, которые даются вам сложно<?php
							break;
						default:
							?>Глибоко опрацюєте теми шкільної програми і теми, які даються вам складно<?php
						} ?></p>
                                                    ...
                                                    <div class="price">
                                                        <?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?><h2>350<span><b>грн./55 хв.</b></span></h2><?php
							break;
						case 'pl':
							?><h2>104<span><b>zl./god</b></span></h2><?php
							break;
						case 'en':
							?><h2>35<span><b>GPB/hour</b></span></h2><?php
							break;
						case 'gb':
							?><h2>35<span><b>GPB/hour</b></span></h2><?php
							break;
						case 'ru':
							?><h2>350<span><b>грн./55 мин.</b></span></h2><?php
							break;
						default:
							?><h2>350<span><b>грн./55 хв.</b></span></h2><?php
						} ?>
						...
						default:
							?>30 уроків<?php
                                                    ...
                                                    <div class="plan-description">
                                                        <p><?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>Закриєте слабкі місця, підготуєтеся до екзамену чи олімпіади<?php
							break;
						case 'pl':
							?>Zamkniesz słabe punkty, przygotujesz się do egzaminu lub olimpiady<?php
							break;
						case 'en':
							?>You will close the weak points, prepare for the exam or the olympiad<?php
							break;
						case 'gb':
							?>You will close the weak points, prepare for the exam or the olympiad<?php
							break;
						case 'ru':
							?>Закроете слабые места, подготовитесь к экзамену или олимпиаде<?php
							break;
						default:
							?>Закриєте слабкі місця, підготуєтеся до екзамену чи олімпіади<?php
						} ?></p>
                                                    ...
                                                    <div class="price">
                                                        <?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?><h2>310<span><b>грн./55 хв.</b></span></h2><?php
							break;
						case 'pl':
							?><h2>94<span><b>zl./god</b></span></h2><?php
							break;
						case 'en':
							?> <h2>31<span><b>GPB/hour</b></span></h2><?php
							break;
						case 'gb':
							?> <h2>31<span><b>GPB/hour</b></span></h2><?php
							break;
						case 'ru':
							?><h2>310<span><b>грн./55 мин.</b></span></h2><?php
							break;
						default:
							?><h2>310<span><b>грн./55 хв</b></span></h2><?php
						} ?>
						...
						default:
							?>60 уроків<?php
                                                    ...
                                                    <div class="plan-description">
                                                        <p><?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>Станете чемпіоном з математики і без проблем вступите в улюблений вищий заклад<?php
							break;
						case 'pl':
							?>Zostaniesz mistrzem matematyki i bez problemu dostaniesz się do ulubionej uczelni wyższej<?php
							break;
						case 'en':
							?>You will become a champion in mathematics and enter your favorite higher institution without any problems<?php
							break;
						case 'gb':
							?>You will become a champion in mathematics and enter your favorite higher institution without any problems<?php
							break;
						case 'ru':
							?>Станете чемпионом по математике и без проблем вступите в любимое высшее заведение<?php
							break;
						default:
							?>Станете чемпіоном з математики і без проблем вступите в улюблений вищий заклад<?php
						} ?></p>
                                                    ...
                                                    <div class="price">
                                                        <?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?><h2>280<span><b>грн./55 хв.</b></span></h2><?php
							break;
						case 'pl':
							?><h2>84<span><b>zl./god</b></span></h2><?php
							break;
						case 'en':
							?><h2>28<span><b>GPB/hour</b></span></h2><?php
							break;
						case 'gb':
							?><h2>28<span><b>GPB/hour</b></span></h2><?php
							break;
						case 'ru':
							?><h2>280<span><b>грн./55 мин.</b></span></h2><?php
							break;
						default:
							?><h2>280<span><b>грн./55 хв.</b></span></h2><?php
						} ?>
						...
						default:
							?>100 уроків<?php
                                                    ...
                                                    <div class="plan-description">
                                                        <p><?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>Отримаєте репетитора на весь навчальний рік<?php
							break;
						case 'pl':
							?>Opiekę pedagogiczną otrzymasz na cały rok akademicki<?php
							break;
						case 'en':
							?>You will receive a tutor for the entire academic year<?php
							break;
						case 'gb':
							?>You will receive a tutor for the entire academic year<?php
							break;
						case 'ru':
							?>Получите репетитора на весь учебный год<?php
							break;
						default:
							?>Отримаєте репетитора на весь навчальний рік<?php
						} ?></p>
                                                    ...
                                                    <div class="price">
                                                        <?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?><h2>260<span><b>грн./55 хв.</b></span></h2><?php
							break;
						case 'pl':
							?><h2>74<span><b>zl./god</b></span></h2><?php
							break;
						case 'en':
							?><h2>26<span><b>GPB/hour</b></span></h2><?php
							break;
						case 'gb':
							?><h2>26<span><b>GPB/hour</b></span></h2><?php
							break;
						case 'ru':
							?><h2>260<span><b>грн./55 мин.</b></span></h2><?php
							break;
						default:
							?><h2>260<span><b>грн./55 хв.</b></span></h2><?php
						} ?>
						...
						default:
							?></span><?php
                                        ...
                                        <button id="nextBtn" style="background: none;border: none;cursor: pointer;image-rendering: inherit;" onclick="nextSlide()">
                                            <img src="https://mathema.me/wp-content/uploads/2024/02/button-next.png" style="image-rendering: inherit;" alt="next">
                                        </button>
					...
					<?php if (ICL_LANGUAGE_CODE == 'en') { ?>
						<style>
							.pricing-section .plan h3 {font-size: 21px;}
							.pricing-section .plan .plan-description {min-height: 140px;}
							@media only screen and (max-width: 991px) {
								.pricing-section .plan .plan-description {min-height: 0;}
							}
                ...
                <div class="tut-reviews teachers-section greybotborder">
                    ...
                    <div class="horizfl marbot5">
                        ...
                        <div class="padleft5 greeny"><?php switch (ICL_LANGUAGE_CODE) {
						case 'uk':
							?>Усі відгуки підтверджено 100%<?php
							break;
						case 'pl':
							?>Wszystkie opinie potwierdzone w 100%<?php
							break;
						case 'en':
							?>All reviews are 100% verified<?php
							break;
						case 'ru':
							?>Все отзывы подтверждены 100%<?php
							break;
						default:
							?>Усі відгуки підтверджено 100%<?php
						} ?></div>
        ...
        <?php switch (ICL_LANGUAGE_CODE) {
                ...
                function PopupFunction(el) {
                    ...
                    jQuery('.tutpopname').text(tutname.text());
                    tutname = jQuery(el).closest('.popdetails').find('.tutid');
                    jQuery('input#input_62_7').val(tutname.text());
                    jQuery('.popuptopphoto').empty();
                    jQuery(el).closest('.popteacher-card').find('.photo').clone().appendTo(".popuptopphoto");
                }
            </script><?php
