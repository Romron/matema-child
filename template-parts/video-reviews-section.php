<div class="video-reviews video-reviews-homepage">
    <div class="container">
        <div class="head">
            <?php if (get_field('video_review_title')): ?>
                <h2><?php echo get_field('video_review_title') ?></h2>
            <?php endif; ?>
            <?php if (get_field('video_review_sub')): ?>
                <p><?php echo get_field('video_review_sub') ?></p>
            <?php endif; ?>
        </div>
