...
/**
 * Template Name: Успіх квізу 10 | Репетитор з математики під ключ
 */
get_header(); ?>
...
<?php if (have_posts()) while (have_posts()) : the_post(); ?>
	...
	<style>
		...
		body .container .diagnostic-form .check {
			margin-top: 55px;
		}

		body .container .diagnostic-form .text {
			margin-top: 18px;
		...
		body .container .diagnostic-form .picture-mob {
			display: none;
		}
		...
		html,
		.page-diagnostic-registration .content {
			background: #E6E6EF;
		}

		.page-template-page-quiz-10-success {
			padding-left: 0;
			padding-right: 0;
			max-width: 1054px;
			margin-right: auto;
		...
		body .container .diagnostic-form .picture {
			margin-bottom: 0;
		}

		@media (max-width: 991px) {
			body .container .diagnostic-form {
				padding: 52px 30px 87px;
			}
