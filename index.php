...
<div class="main-page">
    ...
    <?php
    $video_block_state = get_field('video_block_state');
    if ($video_block_state === true) {
       ?><div class="<?php echo $video_block_state;?>"></div><?php
	   get_template_part('template-parts/video-introduction');
    }

    get_template_part('template-parts/media-about-us');
    get_template_part('template-parts/trustpilot-section');
    get_template_part('template-parts/introduction-section');

    // Include learning programs section only for Polish language
    if (ICL_LANGUAGE_CODE == 'pl') :
        get_template_part('template-parts/learning-programs-section');
    endif;

    get_template_part('template-parts/whyus-section');
    switch (ICL_LANGUAGE_CODE) {
         case 'uk':
    ...
    switch (ICL_LANGUAGE_CODE) {
        ...
        default:
            ...
            get_template_part('template-parts/benefits-section', 'new');
            ...
            get_template_part('template-parts/video-reviews-section');
